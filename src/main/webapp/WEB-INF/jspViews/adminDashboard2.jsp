						...
						<div class="card">
							<div class="card-body">
								<h5 class="card-title">All Employees</h5>
									...
									<table class="table card-table" style="table-layout: fixed; width: 100%; font-size:14px; overflow-y:scroll">
										<tr>
						...
						<div class="card">
							<div class="card-body">
								...
								<!-- Card content -->
									...
									<table class="table" style="table-layout: fixed; width: 100%; font-size:14px; overflow-y:scroll">
										<tr>
										<th>RL ID</th>
										<th>RL Type</th>
										<th>Details</th>
